...
extension CeloSDK: AccountService {
    public var hasAccount: Bool {
        return (try? loadKeystoreWithMnemonics()) != nil
    }
    
    public var address: String? {
        guard let keystore = try? loadKeystoreWithMnemonics() else { return nil }
    ...
    public func privateKey(password: String) throws -> String {
        let keystore = try loadKeystoreWithMnemonics()
    ...
    func loadKeystoreWithMnemonics() throws -> EthereumKeystoreV3 {
